...
public class LocalePicker extends LinearLayout {
    ...
    private static final int DEFAULT_LAYOUT_RESOURCE_ID =
            com.mokee.setupwizard.R.layout.locale_picker;
    ...
    public LocalePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        SELECTOR_WHEEL_ITEM_COUNT = context.getResources().getInteger(com.mokee.setupwizard.R.integer.local_picker_items);
        SELECTOR_MIDDLE_ITEM_INDEX = context.getResources().getInteger(com.mokee.setupwizard.R.integer.local_picker_items)/2;
        ...
        mSelectionDivider = context.getDrawable(com.mokee.setupwizard.R.drawable.divider);
